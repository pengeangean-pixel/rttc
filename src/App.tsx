...
export default function App() {
  ...
  const [students, setStudents] = useState<Student[]>(() => {
    const saved = localStorage.getItem("rttc_students_r01");
    return saved ? JSON.parse(saved) : initialStudentsList;
  });
  ...
  // Persist collections
  useEffect(() => {
    localStorage.setItem("rttc_students_r01", JSON.stringify(students));
  }, [students]);
